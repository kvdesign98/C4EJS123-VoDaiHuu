...
//     {
//         console.log(jobS.hits[i].benefits);
//     } 
// }
// {
//     for( let i = 0 ; i <jobS.hits.length ; i++)
...
//     for (let i = 0 ; i <jobS.hits.length ; i++)
//     {
//         console.log(jobS.hits[i].locations);
//     }
// }
// {
//     for (let i=0; i < jobS.hits.length; i++)
//     {
//         console.log(jobS.hits[i].skills);
//     }   
// }
// {
// for (let i =0 ; i<jobS.hits.length ; i++)
// {
//     console.log(jobS.hits[i].jobRequirement);
// }   
// }
...
// for(let i=0; i<jobS.hits.length; i++)
// {
//     console.log(jobS.hits[i].jobSalary);
// }  
// } 
